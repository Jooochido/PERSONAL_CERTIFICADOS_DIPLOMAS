...
$(document).ready(function(){
    ...
    $.post("../../controller/usuario.php?op=mostrar_curso_detalle", { curd_id : curd_id }, function (data) {
        ...
        /* Ruta de la Imagen */
        image.src = '../../public/certificados/'+data.cur_img+'';
    });
...
// Funcion para navegares antiguos, se reemplaza por getUrlParam
