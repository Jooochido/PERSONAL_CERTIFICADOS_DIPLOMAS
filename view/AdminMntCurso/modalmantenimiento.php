                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width:100%" name="cat_id" id="cat_id" data-placeholder="Seleccione" required>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width:100%" name="inst_id" id="inst_id" data-placeholder="Seleccione" required>
                                <option label="Seleccione"></option>
