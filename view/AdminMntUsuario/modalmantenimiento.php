                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width:100%" name="usu_sex" id="usu_sex" data-placeholder="Seleccione" required>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width:100%" name="rol_id" id="rol_id" data-placeholder="Seleccione" required>
                                <option label="Seleccione"></option>
