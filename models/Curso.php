<?php
    class Curso extends Conectar{
        ...
        public function insert_curso($cat_id,$cur_nom,$cur_descrip,$cur_fechini,$cur_fechfin,$inst_id){
            ...
            parent::set_names();
            $sql="INSERT INTO tm_curso (cat_id, cur_nom, cur_descrip, cur_fechini, cur_fechfin, inst_id, cur_img, fech_crea, est) VALUES (?,?,?,?,?,?,'1.png',NOW(),1)";
        ...
        public function insert_curso_usuario($cur_id,$usu_id){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="INSERT INTO td_curso_usuario (cur_id,usu_id,fech_crea,est) VALUES (?,?,NOW(),1)";
            $sql=$conectar->prepare($sql);
            $sql->bindValue(1, $cur_id);
        ...
        public function upload_file(){
            if(isset($_FILES["cur_img"])){
                ...
                $destination = '../public/certificados/' . $new_name;
